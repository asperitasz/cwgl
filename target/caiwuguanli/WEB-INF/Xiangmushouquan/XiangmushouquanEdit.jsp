                ...
                <form id="form1" action="Edit.action" method="post" class="templatemo-login-form">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 has-success form-group">
                            <label class="control-label" for="beizhu">
                                用户</label>
                            <select class="form-control" id="beizhu" name="beizhu">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 has-success form-group">
                            ...
                            <input type="text" class="form-control" id="kahao" name="kahao" value="${entity.kahao}">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-lg-12 has-success form-group">
                            <label class="control-label" for="mima">
                                密码</label>

                            <input type="text" class="form-control" id="mima" name="mima" value="${entity.mima}">
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 has-success form-group">
                            ...
                            <input type="text" class="form-control" id="jine" name="jine" value="${entity.jine}">
                        </div>
                    </div>
