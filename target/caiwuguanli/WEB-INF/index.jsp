    ...
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="Gongjijintiqujilu/list.action"><i class="fa fa-database fa-fw"></i>公积金提取记录查询</a></li>
                ...
                <nav class="templatemo-top-nav col-lg-12 col-md-12">
                    <ul class="text-uppercase">
                        <c:forEach items="${list}" var="item">
                            <li><a href="JavaScript:;">尾号为${fn:substring(item.kahao,fn:length(item.kahao)-4,fn:length(item.kahao))}的卡号暂未认领，请及时认领</a></li>
                        </c:forEach>
                    </ul>
                </nav>
            </div>
